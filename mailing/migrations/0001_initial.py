    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time', models.TimeField(default=datetime.time(12, 57, 41, 937318), verbose_name='start time for sending')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transmission', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='statistic_of_transmission', to='mailing.transmission')),
            ],
            options={
